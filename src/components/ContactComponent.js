...
class Contact extends Component {
    ...
    validate(firstname,lastname,telnum,email) {
        ...
        if(this.state.touched.email && email.split('').filter(s => s=== '@').length != 1)
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type='tel' id='telnum' name='telnum' value={this.state.telnum} 
                                        placeholder='Tel. number' onChange={this.handleInputChange}
                                        valid={errors.telnum === ''}
                                    ...
                                    <FormGroup check>
                                        <Label check>
                                            <Input type='checkbox' checked={this.state.agree}
                                             name='agree' onChange={this.handleInputChange} />{' '}
                                            <strong>May We contact you?</strong>
                                        </Label>
                                    </FormGroup>
                                </Col>
                                <Col md={{size: 3, offset:1}}>
                                    <Input type='select' value={this.state.contactType} name='contactType'
