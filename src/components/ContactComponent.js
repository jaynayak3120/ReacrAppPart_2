...
const isNumber = (val) => !isNaN(Number(val)); ///^[0-9]{10}$/i.test(val);
                                ...
                                <Col md={10}>
                                    <Control.text model=".firstname" id="firstname" name="firstname"
                                        ...
                                        <Errors className="text-danger" model=".firstname" show='touched'
                                            messages={{
                                                required: " Required",
                                                minLength: " It must be greater than or equal to 3 characters",
                                                maxLength: " It must be less than or equal to 15 characters"
                                            }} />
                                </Col>
                            </Row>
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.text model=".telnum" id="telnum" name="telnum"
                                        ...
                                        messages={{
                                                required: " Required",
                                                minLength: " It must be greater than or equal to 3 characters",
                                                maxLength: " sIt must be less than or equal to 15 characters",
